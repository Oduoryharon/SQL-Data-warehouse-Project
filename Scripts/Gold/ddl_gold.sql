...
=======================================================
This script create view the gold layer in the data warehouse.
The gold layer represent the final dimension and fact table (star schema)

Each view perfom transformations and combines data from silver layer to produce a clean enriched
and business ready dataset.

Usage:
 - The view can be quried directly for analytic and reporting.
...
CREATE VIEW gold.dim_customers AS
	SELECT
		...
		CASE
			WHEN ci.cst_gndr != 'Unknown' THEN ci.cst_gndr --CRM is the master of the gender info
	...
	LEFT JOIN silver.erp_loc_a101 cu
